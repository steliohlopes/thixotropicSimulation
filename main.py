...
newtonianTest.SaveSimulationData(filePath=meshPath,fileName="PipeFlow3DNewtonian")
...
# PowerLawTest.SaveSimulationData(filePath=meshPath,fileName="PipeFlow2DSMD")
...
Thixotropic.SaveSimulationData(filePath=meshPath,fileName="PipeFlow3DThixotropic")
